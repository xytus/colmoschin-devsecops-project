Vagrant.configure("2") do |config|
  ...
  config.vm.define "web-server" do |web|
    ...
    web.vm.network "private_network", type: "dhcp" # Using DHCP for dynamic IP assignment
...
EOF'
  ...
  config.vm.define "db-server" do |db|
    ...
    db.vm.network "private_network", type: "dhcp" # Using DHCP for dynamic IP assignment
